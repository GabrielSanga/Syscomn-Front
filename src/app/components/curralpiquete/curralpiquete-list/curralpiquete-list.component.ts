...
export class CurralpiqueteListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['idCurralPiquete', 'descricao', 'areaPasto', 'curralAltura', 'curralLargura', 'quantidadeCabecas', 'nomePropriedade', 'statusCurralPiquete', 'tipoCurralPiquete', 'acoes'];
